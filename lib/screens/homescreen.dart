...
class _HomeScreenState extends State<HomeScreen> {
  ...
  BluetoothConnection? _blueConnected;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                    ...
                    itemBuilder: (context, index) => MyBlueDeviceTile(
                      ...
                      onTap: () {
                        ...
                        if (BluetoothConnection.fromConnectionId(
                            ...
                            .isConnected) {
                          //////
                          _blueConnected = BluetoothConnection.fromConnectionId(
                              0, _discoveredDevices[index].address);
                          //////////
                          Navigator.push(
                            context,
                            MaterialPageRoute(
          ...
          ElevatedButton(
            onPressed: () {
              print(_blueConnected?.isConnected);
            },
            child: Text('check'),
          ),
        ],
